<template>
    ...
    <div class="card card-container">
        ...
        <form class="form-signin" @submit.prevent="loginUser">
            ...
            <input type="text" v-model="form.email" class="form-control" placeholder="Email address" autofocus>
        ...
        <div>
            ...
            <router-link :to="{ name: 'register.index'}" class="register-user">Đăng ký</router-link>
        </div>
    </div><!-- /card-container -->
</template>
<style>
...
export default {
    ...
    setup() {
        ...
        const {errors, login,isLoading} = auth();
