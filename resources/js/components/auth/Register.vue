<template>
    <div class="card card-container">
        ...
        <form class="form-signin" @submit.prevent="registerUser">
            ...
            <input type="text" v-model="form.name" class="form-control" placeholder="Họ và tên" autofocus>
            <input type="text" v-model="form.email" class="form-control" placeholder="Địa chỉ email" autofocus>
        ...
        <div>
            <router-link :to="{ name: 'login.index'}">Đăng nhập</router-link>
        </div>
    </div><!-- /card-container -->
</template>
<style>
